...
export default function RolledStarterItem({ starterItem }: { starterItem: StarterItem }) {
    ...
    return (
        <div style={{
            ...
            <Image alt={starterItem.name} width={67.2} height={67.2} src={`https://ddragon.leagueoflegends.com/cdn/13.3.1/img/item/${starterItem.id}.png`} style={{ border: 2, borderStyle: "solid", borderRadius: 5, borderColor: HighlightType.Light }} />
        </div>
    );
}